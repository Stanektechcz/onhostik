...
| e2754fa | 2026-09-15 | Go-live on staging: console relay installer for aaPanel (Node from the version manager, relay key generated into app.env, systemd, nginx check); smoke test covers every sold product (--product=key[:plan][@instance], mail domain) and registrar availability (--domain-check); onhost:mail:test; runbook section (audit §5z) |
