...
final class AutomationLedger
{
    ...
    public const RULES = [
        ...
        ['key' => 'backups.as_sold', 'command' => null, 'name' => 'Zálohy přesně podle ceníku', 'does' => 'frekvence 1h/60m se čte jako hodinová a u webových a managed tarifů se nad počet generací drží jedna záloha denně po dobu backup_days; po vypnutí se nadbytečné zálohy při dalším běhu uklidí na dnešní počet generací. Kdo by byl dotčen: onhost:backups:frequency-plan', 'runs' => 'každých 15 minut spolu se Zálohami podle plánu', 'switchable' => true, 'default_off' => true],
