...
final class Lexicon
{
    ...
    public const EN = [
        ...
        ' · API tokeny zůstávají platné: ' => ' · API tokens stay valid: ',
        'AI asistent: vyčerpaný limit ' => 'AI assistant: a limit is used up — ', 'kdo: ' => 'who: ', ' · hodnota limitu: ' => ' · the limit: ', ' · asistent odpovídá podle nápovědy, nic se neodmítá' => ' · the assistant answers from the help centre, nothing is refused',
