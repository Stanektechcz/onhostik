...
final class RoleCatalog
{
    ...
    public static function all(): array
    {
        ...
        return [
            ...
            'developer' => self::role('Developer', 'Apps, deploys, databases, consoles', 'organization', false, array_merge($customerRead, ['service.manage', 'service.console', 'apps.deploy', 'database.manage', 'dns.zone.write', 'support.ticket.write', 'support.chat.use'])),
            'cloud_operator' => self::role('Cloud operator', 'VPS/VDS lifecycle, snapshots, firewall, backups', 'organization', false, array_merge($customerRead, ['service.manage', 'service.console', 'compute.vm.manage', 'compute.vm.delete', 'backup.restore', 'support.ticket.write', 'support.chat.use'])),
            'game_operator' => self::role('Game operator', 'Game servers, console, mods, backups', 'organization', false, array_merge($customerRead, ['service.manage', 'service.console', 'game.manage', 'backup.restore', 'support.ticket.write', 'support.chat.use'])),
            'mail_manager' => self::role('Mail manager', 'Mail domains, mailboxes, DKIM/SPF/DMARC', 'organization', false, array_merge($customerRead, ['mail.manage', 'dns.zone.write', 'support.ticket.write'])),
