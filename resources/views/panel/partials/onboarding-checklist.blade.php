    ...
    <div class="col-span-12">
        <div class="card b-l-warning">
            <div class="card-header pb-0 flex justify-between items-center">
                ...
                <form method="POST" action="{{ route('panel.onboarding.dismiss') }}" class="inline">
                    @csrf
            ...
            <div class="card-body pt-2">
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-12 sm:col-span-6 col-span-12 xl:col-span-3">
                        <div class="flex items-start gap-2 p-2 rounded {{ $done ? 'bg-light-success' : 'bg-light' }}">
                            <span class="mt-1">
                                @if ($done)
                            ...
                            <div>
                                <p class="mb-0 f-13 font-medium {{ $done ? 'text-success' : '' }}">Doplňte profil</p>
                    ...
                    <div class="col-span-12 sm:col-span-6 col-span-12 xl:col-span-3">
                        <div class="flex items-start gap-2 p-2 rounded {{ $done ? 'bg-light-success' : 'bg-light' }}">
                            ...
                            <div>
                                <p class="mb-0 f-13 font-medium {{ $done ? 'text-success' : '' }}">Fakturační adresa</p>
                    ...
                    <div class="col-span-12 sm:col-span-6 col-span-12 xl:col-span-3">
                        <div class="flex items-start gap-2 p-2 rounded {{ $done ? 'bg-light-success' : 'bg-light' }}">
                            ...
                            <div>
                                <p class="mb-0 f-13 font-medium {{ $done ? 'text-success' : '' }}">Dvoufaktorové ověření</p>
                    ...
                    <div class="col-span-12 sm:col-span-6 col-span-12 xl:col-span-3">
                        <div class="flex items-start gap-2 p-2 rounded {{ $done ? 'bg-light-success' : 'bg-light' }}">
                            ...
                            <div>
                                <p class="mb-0 f-13 font-medium {{ $done ? 'text-success' : '' }}">Objednejte první službu</p>
