...
@php
    $breadcrumbTitle = __('panel.nav.billing_details');
    $breadcrumbItems = [__('panel.nav.account') => '#', __('panel.nav.billing_details') => ''];
@endphp
    ...
    <div class="container-fluid">
        ...
        <x-panel.card :title="__('panel.nav.billing_details')" :subtitle="__('panel.account.tax_doc_note')">
            <form method="POST" action="{{ route('panel.account.billing.update') }}" class="row g-3">
                ...
                <div class="col-span-1 md:col-span-3 sm:col-span-6">
