    ...
    <form method="POST" action="{{ $tier->exists ? route('admin.sla-tiers.update', $tier) : route('admin.sla-tiers.store') }}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold">Uptime SLA (×100) <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Odezva podpory (min) <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Čas řešení (hod) <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Kredit za hodinu výpadku (%) <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Max. kredit za měsíc (%) <span class="text-danger">*</span></label>
