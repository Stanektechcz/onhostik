...
<div class="container-fluid">
    ...
    <x-panel.card title="Filtr">
        <form method="GET" action="{{ route('admin.service-firewall-rules.index') }}" class="d-flex gap-2 align-items-end">
            <div>
    ...
    <x-panel.card title="Přidat pravidlo firewallu">
        <form method="POST" action="{{ route('admin.service-firewall-rules.store') }}" class="row g-3">
            @csrf
