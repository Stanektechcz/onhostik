                ...
                <tbody>
                    @forelse($rules as $rule)
                        <tr>
                            ...
                            <td class="text-end small">{{ number_format($rule->run_count) }}</td>
                            ...
                            <td class="text-end">
                                ...
                                <form action="{{ route('admin.automation.destroy', $rule) }}" method="POST" class="d-inline"
