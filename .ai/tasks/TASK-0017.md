...
- `domains/Catalog/PlanPromises.php domains/Services/Metering/MetricRegistry.php tests/Feature/Catalog/PlanPromisesTest.php app/Console/Commands/Doctor.php .ai/tasks/TASK-NNNN.md .ai/handoffs/TASK-NNNN.md`
