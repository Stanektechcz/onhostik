...
| C5.3 | `ViesClient` and `VatValidation` are unwired | ASSUMED | CONFIRMED | As C1a. The baseline entry at `:3562-3565` is stale | MEDIUM as dead code (HIGH as C1) | See TASK-0031 (done: `ViesClient` deleted with its baseline entry) | M |
...
- **Numbering:** TASK-0028 is taken by Fikoun's unpushed `chore/TASK-0028-portable-toolchain-and-ai-docs`, so new ids start at TASK-0029. **Renumbered 2026-09-26:** the VIES work was done as TASK-0031 (proposed here as TASK-0033), so the deploy gate is now TASK-0032 (was TASK-0031) and the production fail-closed configuration TASK-0033 (was TASK-0032); TASK-0034 onwards are unchanged. TASK-0029 … TASK-0031 are done on the stack branch of PR #24 (not merged into `development` yet; decisions in `docs/adr/0008-audit-high-fixes-2026-09-25.md`).
