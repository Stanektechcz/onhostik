...
/** A VIES verdict recorded the way the platform's own check records it (system actor, through the bus; TASK-0031). */
...
it('accrues commission from paid client invoices, reverses on credit notes, follows tiers, and pays out by self-billing after step-up', function () {
    ...
    recordValidVatForTest($partnerOrg, 'CZ12345678'); // VAT payer (VIES confirmed the DIČ) → self-billed invoice carries 21 % VAT from standard_rates
