...
final class CatalogSeeder extends Seeder
{
    public function run(): void
    {
        $this->product('web-hosting', 'web', 'ispconfig', 'subscription', ['cs' => 'Webhosting', 'en' => 'Web hosting'], ['cs' => 'Sdílený PHP/WordPress hosting na NVMe s vlastními limity na projekt.', 'en' => 'Shared PHP/WordPress hosting on NVMe with per-project limits.'], 10, ['chips' => ['NVMe RAID10', 'PHP 8.1–8.4', 'HTTP/3', 'Zálohy 30 dní'], 'persona' => 'web', 'addon_products' => ['ssl', 'cdn', 'backup-plus']], [
            ['start', ['cs' => 'Start', 'en' => 'Start'], 8900, 89000, 390, 3900, false, 'standard', ['sites' => 1, 'nvme_gb' => 10, 'php_workers' => 2, 'php_memory_mb' => 512, 'mailboxes' => 5, 'databases' => 1, 'db_connections' => 20, 'backup_days' => 7, 'backup_generations' => 7, 'traffic' => 'fair-use 500 GB/měs', 'ssh' => false, 'staging' => false, 'waf' => 'basic', 'php_versions' => ['8.2', '8.3', '8.4'], 'inodes' => 250000, 'cron_concurrency' => 1, 'outbound_mail_per_hour' => 100], ['cpu_seconds_per_day' => 7200], ['cs' => 'Pro první web nebo portfolio.', 'en' => 'For a first site or a portfolio.'], ['cs' => ['1 web', '10 GB NVMe', '5 schránek', '1 databáze', 'Zálohy 7 dní', 'Certifikát zdarma'], 'en' => ['1 site', '10 GB NVMe', '5 mailboxes', '1 database', '7-day backups', 'Free certificate']]],             ['standard', ['cs' => 'Standard', 'en' => 'Standard'], 18900, 189000, 790, 7900, true, 'standard', ['sites' => 10, 'nvme_gb' => 50, 'php_workers' => 6, 'php_memory_mb' => 1024, 'mailboxes' => 50, 'databases' => 20, 'db_connections' => 50, 'backup_days' => 30, 'backup_generations' => 30, 'traffic' => 'fair-use 2 TB/měs', 'ssh' => true, 'staging' => true, 'waf' => 'standard', 'php_versions' => ['8.1', '8.2', '8.3', '8.4'], 'inodes' => 1000000, 'cron_concurrency' => 2, 'outbound_mail_per_hour' => 300], ['cpu_seconds_per_day' => 28800], ['cs' => 'Pro weby, které mají návštěvnost.', 'en' => 'For sites with real traffic.'], ['cs' => ['10 webů', '50 GB NVMe', '50 schránek', '20 databází', 'Zálohy 30 dní', 'Staging na klik'], 'en' => ['10 sites', '50 GB NVMe', '50 mailboxes', '20 databases', '30-day backups', 'One-click staging']]],             ['profi', ['cs' => 'Profi', 'en' => 'Pro'], 44900, 449000, 1890, 18900, false, 'business', ['sites' => 50, 'nvme_gb' => 200, 'php_workers' => 12, 'php_workers_dedicated' => true, 'php_memory_mb' => 2048, 'mailboxes' => 500, 'databases' => 100, 'db_connections' => 100, 'backup_days' => 90, 'backup_generations' => 90, 'traffic' => 'fair-use 5 TB/měs', 'ssh' => true, 'staging' => true, 'waf' => 'advanced+cdn', 'php_versions' => ['8.1', '8.2', '8.3', '8.4'], 'inodes' => 4000000, 'cron_concurrency' => 4, 'outbound_mail_per_hour' => 1000], ['cpu_seconds_per_day' => 86400], ['cs' => 'Pro e-shopy a klientské weby.', 'en' => 'For shops and client sites.'], ['cs' => ['50 webů', '200 GB NVMe', '500 schránek', 'Dedikované PHP workery', 'Zálohy 90 dní', 'WAF + CDN'], 'en' => ['50 sites', '200 GB NVMe', '500 mailboxes', 'Dedicated PHP workers', '90-day backups', 'WAF + CDN']]],         ]);
        ...
        $this->product('web-custom', 'web', 'ispconfig', 'subscription', ['cs' => 'Webhosting na míru', 'en' => 'Custom web hosting'], ['cs' => 'Sestavte si tarif přesně podle projektu: weby, prostor, schránky, databáze a zálohy platíte jen v množství, které potřebujete.', 'en' => 'Build the plan your project needs: pay for exactly the sites, storage, mailboxes, databases and backups you use.'], 12, ['persona' => 'web', 'builder' => true, 'chips' => ['NVMe RAID10', 'PHP 8.1–8.4', 'HTTP/3'], 'addon_products' => ['ssl', 'cdn', 'backup-plus']], [
            ['custom', ['cs' => 'Na míru', 'en' => 'Custom'], 4900, 49000, 199, 1990, false, 'standard', ['sites' => 1, 'nvme_gb' => 5, 'php_workers' => 2, 'php_memory_mb' => 512, 'mailboxes' => 3, 'databases' => 1, 'db_connections' => 20, 'backup_days' => 7, 'backup_generations' => 7, 'traffic' => 'fair-use 500 GB/měs', 'ssh' => false, 'staging' => false, 'waf' => 'basic', 'php_versions' => ['8.2', '8.3', '8.4'], 'inodes' => 250000, 'cron_concurrency' => 1, 'outbound_mail_per_hour' => 100], ['cpu_seconds_per_day' => 7200], ['cs' => 'Základ, ke kterému si přidáte jen to, co potřebujete.', 'en' => 'A base you extend with only what you need.'], ['cs' => ['1 web', '5 GB NVMe', '3 schránky', '1 databáze', 'Zálohy 7 dní', 'Certifikát zdarma'], 'en' => ['1 site', '5 GB NVMe', '3 mailboxes', '1 database', '7-day backups', 'Free certificate']]],
        ]);
        ...
        $this->product('wordpress', 'managed', 'aapanel', 'subscription', ['cs' => 'Managed WordPress', 'en' => 'Managed WordPress'], ['cs' => 'WordPress a WooCommerce se správou, aktualizacemi a dohledem.', 'en' => 'WordPress and WooCommerce with updates, monitoring and tuning.'], 20, ['persona' => 'eshop', 'responsibility_matrix' => 'docs/support/managed-responsibility.md', 'addon_products' => ['ssl', 'cdn']], [
            ['managed-wp', ['cs' => 'Managed WP', 'en' => 'Managed WP'], 69000, 690000, 2900, 29000, true, 'business', ['sites' => 1, 'nvme_gb' => 40, 'php_workers' => 8, 'php_memory_mb' => 2048, 'object_cache' => 'redis', 'backup_days' => 30, 'backup_frequency' => '6h', 'monitoring' => true, 'updates' => 'core+plugins staged', 'support' => 'chat 30 min', 'staging' => true], ['cpu_seconds_per_day' => 43200]],
            ['managed-woo', ['cs' => 'Managed WooCommerce', 'en' => 'Managed WooCommerce'], 149000, 1490000, 6200, 62000, false, 'business', ['sites' => 1, 'nvme_gb' => 120, 'php_workers' => 16, 'php_memory_mb' => 4096, 'object_cache' => 'redis', 'backup_days' => 30, 'backup_frequency' => '1h', 'monitoring' => true, 'updates' => 'core+plugins staged', 'support' => 'priority 10 min', 'staging' => true, 'dedicated_db' => true], ['cpu_seconds_per_day' => 86400]],
        ]);
        ...
        $this->product('eshop', 'managed', 'aapanel', 'subscription', ['cs' => 'E-shop hosting', 'en' => 'E-shop hosting'], ['cs' => 'WooCommerce, PrestaShop a Shopware s objektovou cache, WAF a zálohami několikrát denně.', 'en' => 'WooCommerce, PrestaShop and Shopware with object cache, WAF and backups several times a day.'], 22, ['persona' => 'eshop', 'chips' => ['Redis', 'WAF', 'Zálohy 4× denně'], 'addon_products' => ['ssl', 'cdn']], [
            ['shop-start', ['cs' => 'Shop Start', 'en' => 'Shop Start'], 39000, 390000, 1590, 15900, false, 'standard', ['products' => 1000, 'nvme_gb' => 60, 'php_workers' => 4, 'php_memory_mb' => 1024, 'object_cache' => 'redis', 'backup_frequency' => '6h', 'backup_days' => 30, 'waf' => 'basic', 'staging' => true, 'mailboxes' => 20, 'databases' => 5], ['cpu_seconds_per_day' => 43200]],
            ['shop-growth', ['cs' => 'Shop Growth', 'en' => 'Shop Growth'], 99000, 990000, 3990, 39900, true, 'business', ['products' => 20000, 'nvme_gb' => 200, 'php_workers' => 12, 'php_memory_mb' => 2048, 'object_cache' => 'redis', 'backup_frequency' => '1h', 'backup_days' => 30, 'waf' => 'pro', 'staging' => true, 'mailboxes' => 100, 'databases' => 20, 'support' => 'chat 30 min'], ['cpu_seconds_per_day' => 86400]],
        ...
        $this->product('vps', 'cloud', 'proxmox', 'hourly', ['cs' => 'VPS', 'en' => 'VPS'], ['cs' => 'KVM na Proxmox VE, hodinové účtování s měsíčním stropem, IPv6 v ceně.', 'en' => 'KVM on Proxmox VE, hourly billing with a monthly cap, IPv6 included.'], 30, ['persona' => 'sysadmin', 'cpu_class' => 'shared', 'images' => ['debian-13', 'ubuntu-24.04', 'ubuntu-22.04', 'rocky-9', 'alma-9'], 'addon_products' => ['backup-plus', 'backup-hourly', 'cdn']], [
            ['compute-2', ['cs' => 'Compute 2', 'en' => 'Compute 2'], 24900, 249000, 990, 9900, false, 'standard', ['vcpu' => 2, 'cpu_class' => 'shared', 'ram_mb' => 4096, 'nvme_gb' => 80, 'traffic_tb' => 5, 'ipv6' => '/64', 'ipv4' => 'addon', 'snapshots' => 3, 'backup' => 'addon', 'console' => 'noVNC/serial'], ['pps_limit' => 100000]],
            ['compute-4', ['cs' => 'Compute 4', 'en' => 'Compute 4'], 44900, 449000, 1790, 17900, true, 'standard', ['vcpu' => 4, 'cpu_class' => 'shared', 'ram_mb' => 8192, 'nvme_gb' => 160, 'traffic_tb' => 8, 'ipv6' => '/64', 'ipv4' => 'addon', 'snapshots' => 5, 'backup' => 'addon', 'console' => 'noVNC/serial'], ['pps_limit' => 200000]],
            ['compute-8', ['cs' => 'Compute 8', 'en' => 'Compute 8'], 84900, 849000, 3390, 33900, false, 'standard', ['vcpu' => 8, 'cpu_class' => 'performance', 'ram_mb' => 16384, 'nvme_gb' => 320, 'traffic_tb' => 12, 'ipv6' => '/64', 'ipv4' => 'addon', 'snapshots' => 10, 'backup' => 'addon', 'console' => 'noVNC/serial'], ['pps_limit' => 400000]],
            ['compute-16', ['cs' => 'Compute 16', 'en' => 'Compute 16'], 169000, 1690000, 6790, 67900, false, 'standard', ['vcpu' => 16, 'cpu_class' => 'performance', 'ram_mb' => 32768, 'nvme_gb' => 640, 'traffic_tb' => 20, 'ipv6' => '/64', 'ipv4' => 'addon', 'snapshots' => 10, 'backup' => 'addon', 'console' => 'noVNC/serial'], ['pps_limit' => 800000]],
        ], hourly: true);
        ...
        $this->product('game', 'game', 'pterodactyl', 'daily', ['cs' => 'Herní server', 'en' => 'Game server'], ['cs' => 'Minecraft, CS2, Rust, ARK, Valheim a další s konzolí, mody a zálohami.', 'en' => 'Minecraft, CS2, Rust, ARK, Valheim and more with console, mods and backups.'], 40, ['persona' => 'gamer', 'hardware_class' => 'AMD Ryzen 9 7950X3D / 9950X, NVMe', 'eggs' => ['minecraft-paper', 'minecraft-spigot', 'minecraft-forge', 'cs2', 'rust', 'ark', 'valheim', 'palworld']], [
