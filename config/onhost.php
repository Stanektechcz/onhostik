...
return [
    ...
    'game' => [
        ...
        'eggs' => [
            'minecraft-paper' => ['label' => 'Minecraft · Paper', 'note' => 'nejrozšířenější Minecraft server s pluginy', 'nest' => '/minecraft/i', 'egg' => '/^paper$/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 150, 'environment' => ['MINECRAFT_VERSION' => 'latest', 'BUILD_NUMBER' => 'latest'], 'versions' => ['1.21.8', '1.21.7', '1.21.4', '1.20.6'], 'import' => 'pelican-eggs/minecraft (paper)'],
            'minecraft-spigot' => ['label' => 'Minecraft · Spigot', 'note' => 'Bukkit/Spigot pluginy; verze podle objednávky (výchozí 1.21.8)', 'nest' => '/minecraft/i', 'egg' => '/^spigot/i', 'fallback_egg' => '/^paper$/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 150, 'environment' => ['MINECRAFT_VERSION' => '1.21.8', 'BUILD_NUMBER' => 'latest', 'SERVER_JARFILE' => 'spigot-{version}.jar'], 'versions' => ['1.21.8', '1.21.7', '1.21.4', '1.20.6'], 'docker_image' => 'ghcr.io/pterodactyl/yolks:java_21', 'startup' => 'bash onhost-start.sh', 'startup_script' => '#!/bin/bash
...
', 'import' => 'pelican-eggs/minecraft (spigot); without it the Paper egg hosts a self-built Spigot: the startup command runs BuildTools on the first start (SpigotMC ships no jar downloads)'], // §5o/§5q: the Paper egg runs Spigot when the panel has no Spigot egg
            'minecraft-forge' => ['label' => 'Minecraft · Forge', 'note' => 'modpacky a mody pro Forge', 'nest' => '/minecraft/i', 'egg' => '/forge/i', 'min_ram_mb' => 4096, 'min_vcpu' => 2, 'min_nvme_gb' => 20, 'slot_mb' => 300, 'environment' => [], 'import' => 'pelican-eggs/minecraft (forge)'],
            'minecraft-purpur' => ['label' => 'Minecraft · Purpur', 'note' => 'Paper s dalšími herními volbami, pluginy Bukkit/Paper', 'nest' => '/minecraft/i', 'egg' => '/^purpur$/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 150, 'environment' => ['MINECRAFT_VERSION' => 'latest'], 'versions' => ['1.21.8', '1.21.7', '1.21.4', '1.20.6'], 'import' => 'pelican-eggs/minecraft (purpur)'],
            'minecraft-vanilla' => ['label' => 'Minecraft · Vanilla', 'note' => 'oficiální server Mojang bez modů', 'nest' => '/minecraft/i', 'egg' => '/^vanilla minecraft$/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 200, 'environment' => [], 'import' => 'pelican-eggs/minecraft (vanilla)'],
            'minecraft-bedrock' => ['label' => 'Minecraft · Bedrock', 'note' => 'pro konzole, mobily a Windows edici (UDP)', 'nest' => '/minecraft/i', 'egg' => '/^vanilla bedrock$/i', 'min_ram_mb' => 1024, 'min_vcpu' => 1, 'min_nvme_gb' => 5, 'slot_mb' => 100, 'environment' => [], 'import' => 'pelican-eggs/minecraft (bedrock)'],
            'minecraft-sponge' => ['label' => 'Minecraft · Sponge', 'note' => 'SpongeVanilla s pluginy Sponge API', 'nest' => '/minecraft/i', 'egg' => '/^sponge/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 200, 'environment' => [], 'import' => 'pelican-eggs/minecraft (sponge)'],
            'minecraft-bungeecord' => ['label' => 'Minecraft · BungeeCord', 'note' => 'proxy spojující více Minecraft serverů', 'nest' => '/minecraft/i', 'egg' => '/^bungee ?cord$/i', 'min_ram_mb' => 1024, 'min_vcpu' => 1, 'min_nvme_gb' => 5, 'slot_mb' => 50, 'environment' => [], 'import' => 'pelican-eggs/minecraft (bungeecord)'],
            '7-days-to-die' => ['label' => '7 Days To Die', 'note' => 'survival horor; doporučeno 8 GB', 'nest' => '/onhost|steam/i', 'egg' => '/^7 days to die$/i', 'min_ram_mb' => 6144, 'min_vcpu' => 2, 'min_nvme_gb' => 30, 'slot_mb' => 512, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (7_days_to_die)'],
            'arma-reforger' => ['label' => 'Arma Reforger', 'note' => 'scénář a mody ve Startup', 'nest' => '/onhost|steam/i', 'egg' => '/^arma reforger$/i', 'min_ram_mb' => 6144, 'min_vcpu' => 2, 'min_nvme_gb' => 30, 'slot_mb' => 512, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (arma_reforger)'],
            'dayz' => ['label' => 'DayZ', 'note' => 'stažení serveru vyžaduje Steam účet s DayZ (Startup)', 'nest' => '/onhost|steam/i', 'egg' => '/^dayz$/i', 'min_ram_mb' => 6144, 'min_vcpu' => 2, 'min_nvme_gb' => 30, 'slot_mb' => 256, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (dayz)'],
            'enshrouded' => ['label' => 'Enshrouded', 'note' => 'kooperace až 16 hráčů', 'nest' => '/onhost|steam/i', 'egg' => '/^enshrouded$/i', 'min_ram_mb' => 6144, 'min_vcpu' => 2, 'min_nvme_gb' => 20, 'slot_mb' => 384, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (enshrouded)'],
            'factorio' => ['label' => 'Factorio', 'note' => 'mapa se vytvoří při prvním startu', 'nest' => '/onhost/i', 'egg' => '/^factorio$/i', 'min_ram_mb' => 2048, 'min_vcpu' => 1, 'min_nvme_gb' => 5, 'slot_mb' => 128, 'environment' => [], 'import' => 'pelican-eggs/games-standalone (factorio)'],
            'hytale' => ['label' => 'Hytale', 'note' => 'dedikovaný server Hytale', 'nest' => '/onhost/i', 'egg' => '/^hytale$/i', 'min_ram_mb' => 4096, 'min_vcpu' => 1, 'min_nvme_gb' => 10, 'slot_mb' => 200, 'environment' => [], 'import' => 'pelican-eggs/games-standalone (hytale)'],
            'project-zomboid' => ['label' => 'Project Zomboid', 'note' => 'heslo správce ve Startup', 'nest' => '/onhost|steam/i', 'egg' => '/^project zomboid$/i', 'min_ram_mb' => 4096, 'min_vcpu' => 2, 'min_nvme_gb' => 20, 'slot_mb' => 256, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (project_zomboid)'],
            'rust-autowipe' => ['label' => 'Rust (autowipe)', 'note' => 'automatický wipe podle plánu; doporučeno 16 GB', 'nest' => '/onhost/i', 'egg' => '/^rust autowipe$/i', 'min_ram_mb' => 8192, 'min_vcpu' => 2, 'min_nvme_gb' => 40, 'slot_mb' => 128, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (rust_autowipe)'],
            'satisfactory' => ['label' => 'Satisfactory', 'note' => 'server se nárokuje v klientovi hry', 'nest' => '/onhost|steam/i', 'egg' => '/^satisfactory$/i', 'min_ram_mb' => 8192, 'min_vcpu' => 2, 'min_nvme_gb' => 20, 'slot_mb' => 1024, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (satisfactory)'],
            'terraria' => ['label' => 'Terraria', 'note' => 'vanilla server, svět se vytvoří při prvním startu', 'nest' => '/onhost/i', 'egg' => '/^terraria( vanilla)?$/i', 'min_ram_mb' => 1024, 'min_vcpu' => 1, 'min_nvme_gb' => 5, 'slot_mb' => 64, 'environment' => [], 'import' => 'pelican-eggs/games-standalone (terraria vanilla)'],
            'v-rising' => ['label' => 'V Rising', 'note' => 'nastavení hry ve Startup', 'nest' => '/onhost|steam/i', 'egg' => '/^v ?rising$/i', 'min_ram_mb' => 4096, 'min_vcpu' => 2, 'min_nvme_gb' => 20, 'slot_mb' => 256, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (v_rising)'],
            'cs2' => ['label' => 'Counter-Strike 2', 'note' => 'vyžaduje Steam Game Server Login Token (nastavíte ve Startup)', 'nest' => '/onhost|source|steam|counter/i', 'egg' => '/counter[- ]?strike(:)? ?2|^cs2$/i', 'min_ram_mb' => 4096, 'min_vcpu' => 2, 'min_nvme_gb' => 60, 'slot_mb' => 128, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (counter_strike_2)'],
            'rust' => ['label' => 'Rust', 'note' => 'mapa se generuje při prvním startu; doporučeno 16 GB', 'nest' => '/rust|steam/i', 'egg' => '/^rust$/i', 'min_ram_mb' => 8192, 'min_vcpu' => 2, 'min_nvme_gb' => 40, 'slot_mb' => 128, 'environment' => ['WORLD_SIZE' => '3000', 'MAX_PLAYERS' => '50'], 'import' => 'pelican-eggs/games-steamcmd (rust)'],
            'ark' => ['label' => 'ARK: Survival Evolved', 'note' => 'mapa TheIsland, hesla ve Startup', 'nest' => '/source|steam|ark/i', 'egg' => '/ark/i', 'min_ram_mb' => 8192, 'min_vcpu' => 2, 'min_nvme_gb' => 60, 'slot_mb' => 256, 'environment' => ['SERVER_MAP' => 'TheIsland'], 'import' => 'pelican-eggs/games-steamcmd (ark_survival_evolved)'],
            'valheim' => ['label' => 'Valheim', 'note' => 'název světa a heslo ve Startup', 'nest' => '/onhost|valheim|steam/i', 'egg' => '/valheim/i', 'min_ram_mb' => 4096, 'min_vcpu' => 2, 'min_nvme_gb' => 10, 'slot_mb' => 384, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (valheim)'],
            'palworld' => ['label' => 'Palworld', 'note' => 'doporučeno 16 GB pro 8+ hráčů', 'nest' => '/onhost|palworld|steam/i', 'egg' => '/palworld/i', 'min_ram_mb' => 8192, 'min_vcpu' => 2, 'min_nvme_gb' => 30, 'slot_mb' => 512, 'environment' => [], 'import' => 'pelican-eggs/games-steamcmd (palworld)'],
        ],
