...
return [
    ...
    'game' => [
        ...
        'eggs' => [
            'minecraft-paper' => ['label' => 'Minecraft · Paper', 'note' => 'nejrozšířenější Minecraft server s pluginy', 'nest' => '/minecraft/i', 'egg' => '/^paper$/i', 'min_ram_mb' => 2048, 'environment' => ['MINECRAFT_VERSION' => 'latest', 'BUILD_NUMBER' => 'latest'], 'versions' => ['1.21.8', '1.21.7', '1.21.4', '1.20.6'], 'import' => 'pelican-eggs/minecraft (paper)'],
...
', 'import' => 'pelican-eggs/minecraft (spigot); without it the Paper egg hosts a self-built Spigot: the startup command runs BuildTools on the first start (SpigotMC ships no jar downloads)'], // §5o/§5q: the Paper egg runs Spigot when the panel has no Spigot egg
            ...
            'minecraft-purpur' => ['label' => 'Minecraft · Purpur', 'note' => 'Paper s dalšími herními volbami, pluginy Bukkit/Paper', 'nest' => '/minecraft/i', 'egg' => '/^purpur$/i', 'min_ram_mb' => 2048, 'environment' => ['MINECRAFT_VERSION' => 'latest'], 'versions' => ['1.21.8', '1.21.7', '1.21.4', '1.20.6'], 'import' => 'pelican-eggs/minecraft (purpur)'],
